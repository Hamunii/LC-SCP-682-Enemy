...
public class SCP682AnimatorAudio : MonoBehaviour
{
    ...
    public AudioSource CreatureSFX { get; private set; } = null!;

    [field: SerializeField]
    public AudioSource CreatureVoice { get; private set; } = null!;

    [field: SerializeField]
    public List<AudioClip> WalkSFX { get; private set; } = [];

    [field: SerializeField]
    public List<AudioClip> RunSFX { get; private set; } = [];

    [field: SerializeField]
    public List<AudioClip> RoarSFX { get; private set; } = [];

    [field: SerializeField]
    public List<AudioClip> BiteSFX { get; private set; } = [];
