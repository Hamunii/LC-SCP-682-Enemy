...
<Project>
   ...
   <PropertyGroup>
      ...
      <!-- The path to where the assemblies get copied to -->
...
"""
   ...
   fp = open(f'{thisPath}/Plugin/SCP682.props.user', 'w')
   fp.write(userFile)
   fp.close()
   print(color.green + f'csproj.user file created at {thisPath}/Plugin/SCP682.props.user!')
